        ...
        <div className="w-full text-center space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          >
            ...
            <Button 
              ...
              className="w-full sm:w-auto border-white/30 text-white hover:bg-white hover:text-gray-900 backdrop-blur-sm px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg group"
            >
            ...
            <Button 
              variant="ghost" 
              size="lg" 
              className="w-full sm:w-auto text-white hover:text-blue-300 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg group"
            >
